...
Submit with No Country
    country-language.load country and language
    click button                        ${countryLangsubmit}
    check if error message is correct   ${countryError}         ${countryErrorMessage}
...
No Email or Password
    ...
    resources.check if error message is correct   ${emailErrMessage}      ${requiredEmail}
    resources.check if error message is correct   ${passwordErrMessage}   ${requiredpassword}
...
Correct email, wrong password
    ...
    resources.check if error message is correct  ${loginErrMessage}   ${loginErrText}
